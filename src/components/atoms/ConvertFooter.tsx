...
export default function Footer({onConvert, disabled}: FooterProps) {
    ...
    return(
        <div className="p-[8px] b-0 bg-emerald-700 border-0 rounded-b-lg flex justify-center item-center">
            <span onClick={onConvert} className="flex flex-col justify-center hover:p-[2px] hover:text-sm items-center hover:rounded-b-lg hover:transition-all  hover:bg-emerald-800">
