...
function LearnPage() {
  return (
    <div>
        <Link to='/'>
            <span className="flex justify-start rounded-2xl p-2 ">
                <IoMdArrowDropleftCircle size={20} className="bg-white"/>
                <p className="text-sm">Home</p>
            </span>
        </Link>
        <h2 className="text-black">Learn More About This Product Here!</h2>
        <p className="text-[14px] text-white font-serif p-3 text-start bg-amber-800 mx-8 rounded-lg mt-2">
